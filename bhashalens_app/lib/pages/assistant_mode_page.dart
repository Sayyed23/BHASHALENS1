...
class _AssistantModePageState extends State<AssistantModePage> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            _buildLangCol("INPUT", "Hindi (Auto)", textGrey,
                                textDark, primaryBlue),
                            Container(
                                height: 30,
                                width: 1,
                            ...
                            _buildLangCol("TARGET", "English", textGrey,
                ...
                itemBuilder: (context, index) {
                  ...
                  if (isMe) {
                    ...
                    return _buildBotBubble(
                        msg['text'], cardWhite, textDark, primaryBlue);
                  }
                },
              ),
            ),
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              hintText:
                                  "Ask something like: How do I ask for help?",
                              hintStyle: TextStyle(
  ...
  Widget _buildLangCol(String label, String value, Color labelColor,
      Color valColor, Color iconColor) {
    return Expanded(
      child: Column(
  ...
  Widget _buildBotBubble(
      String text, Color bg, Color textPlain, Color primary) {
